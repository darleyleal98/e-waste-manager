...
fun EquipamentVoltage(
    ...
    TextField(
        value = registrationViewModel.equipamentVoltage,
        onValueChange = {
            registrationViewModel.equipamentVoltage = it
            isValid = it.isNotEmpty()
        },
        isError = !isValid,
        label = {
            Text(stringResource(R.string.voltagem_do_equipamento), color = Color.White)
        },
        supportingText = {
            if(!isValid) {
                Text(
